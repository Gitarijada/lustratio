...
document.addEventListener('DOMContentLoaded', function() {
    const regionSelect = document.getElementById('region_id2');
    const locationSelect = document.getElementById('location_id2');

    const divElement = document.getElementById("location_after2");
    const local_Select = document.getElementById('local_id2');
